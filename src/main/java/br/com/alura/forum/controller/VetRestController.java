...
public class VetRestController {
    ...
    public ResponseEntity<Vet> getVet(@PathVariable("vetId") long vetId) {
    ...
    public ResponseEntity<Vet> addVet(@RequestBody @Valid Vet vet, BindingResult bindingResult,
    ...
    public ResponseEntity<Vet> updateVet(@PathVariable("vetId") long vetId, @RequestBody @Valid Vet vet,
    ...
    @Transactional
    public ResponseEntity<Void> deleteVet(@PathVariable("vetId") long vetId) {
        Vet vet = this.clinicService.findVetById(vetId);
        if (vet == null) {
